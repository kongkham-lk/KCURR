...
import io.kongkham.kcurr.Models.*;
import io.kongkham.kcurr.Services.CurrService;
...
public class CurrController {
    ...
    public HashMap<String, CurrCountriesResponse> getCurrCountriesFromCurrencyBeacon() {
