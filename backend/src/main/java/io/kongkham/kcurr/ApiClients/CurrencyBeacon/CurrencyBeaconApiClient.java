...
public class CurrencyBeaconApiClient implements ExchangeRateApiClient {
    ...
    public HashMap<String, CurrCountriesResponse> getCurrCountries() {
        ...
        CurrencyBeaconCurrCountriesApiResponse currCountriesRes = _webClient.get()
                ...
                .block();
        HashMap<String, CurrCountriesResponse> currCountries = transformedCurrCountriesResData(currCountriesRes);
        return currCountries;
    }

    private HashMap<String, CurrCountriesResponse> transformedCurrCountriesResData(CurrencyBeaconCurrCountriesApiResponse currCountriesRes) {
